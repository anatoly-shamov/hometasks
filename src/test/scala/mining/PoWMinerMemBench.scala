...
class PoWMinerMemBench extends Bench.LocalTime {
  ...
  val dataSizes = Gen.exponential("size")(1024 * 1024, 1024 * 1024, 4)
  ...
  val parallelismLevels = Gen.range("parallelismLevel")(4, 4, 1)
